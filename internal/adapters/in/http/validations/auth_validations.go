...
func ValidateRegisterUserRequestBody(body *v1.RegisterJSONRequestBody) (RegisterUserRequest, error) {
	if body == nil {
...
func ValidateLoginUserRequestBody(body *v1.LoginJSONRequestBody) (LoginUserRequest, error) {
	if body == nil {
